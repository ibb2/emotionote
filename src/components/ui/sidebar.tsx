    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-sidebar group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border group-data-[variant=inset]:rounded-2xl group-data-[variant=inset]:shadow-sm"
        >
          {children}
        </div>
      </div>
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "relative flex min-w-0 flex-1 flex-col bg-background md:m-2 md:ml-0 md:overflow-hidden md:rounded-2xl md:border md:border-sidebar-border md:shadow-sm md:peer-data-[state=collapsed]:ml-2",
        className
      )}
      {...props}
    />
